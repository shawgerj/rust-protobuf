...
pub struct Type {
    ...
    pub fields_offset: ::std::vec::Vec<u64>,
    pub oneofs: ::protobuf::RepeatedField<::std::string::String>,
    pub oneofs_offset: ::std::vec::Vec<u64>,
    ...
    fn merge_from(&mut self, is: &mut ::protobuf::CodedInputStream<'_>) -> ::protobuf::ProtobufResult<()> {
        while !is.eof()? {
            ...
            match field_number {
                ...
                2 => {
                    ::protobuf::rt::read_repeated_message_into(wire_type, is, &mut self.fields, &mut self.fields_offset)?;
                },
                3 => {
                    ::protobuf::rt::read_repeated_string_into(wire_type, is, &mut self.oneofs, &mut self.oneofs_offset)?;
                },
                4 => {
    ...
    fn merge_from(&mut self, is: &mut ::protobuf::CodedInputStream<'_>) -> ::protobuf::ProtobufResult<()> {
        while !is.eof()? {
            ...
            match field_number {
                ...
                10 => {
                    ::protobuf::rt::read_singular_proto3_string_into(wire_type, is, &mut self.json_name, &mut self.json_name_offset)?;
                },
                11 => {
                    ::protobuf::rt::read_singular_proto3_string_into(wire_type, is, &mut self.default_value, &mut self.default_value_offset)?;
                },
                _ => {
                    ::protobuf::rt::read_unknown_or_skip_group(field_number, wire_type, is, self.mut_unknown_fields())?;
                },
...
pub struct Enum {
    ...
    pub enumvalue_offset: ::std::vec::Vec<u64>,
    pub options: ::protobuf::RepeatedField<Option>,
    pub options_offset: ::std::vec::Vec<u64>,
    pub source_context: ::protobuf::SingularPtrField<::protobuf::well_known_types::SourceContext>,
    pub source_context_offset: u64,
    ...
    fn merge_from(&mut self, is: &mut ::protobuf::CodedInputStream<'_>) -> ::protobuf::ProtobufResult<()> {
        while !is.eof()? {
            ...
            match field_number {
                ...
                2 => {
                    ::protobuf::rt::read_repeated_message_into(wire_type, is, &mut self.enumvalue, &mut self.enumvalue_offset)?;
                },
                3 => {
                    ::protobuf::rt::read_repeated_message_into(wire_type, is, &mut self.options, &mut self.options_offset)?;
                },
    ...
    fn merge_from(&mut self, is: &mut ::protobuf::CodedInputStream<'_>) -> ::protobuf::ProtobufResult<()> {
        while !is.eof()? {
            ...
            match field_number {
                ...
                2 => {
                    ::protobuf::rt::read_singular_message_into(wire_type, is, &mut self.value, &mut self.value_offset)?;
                },
                _ => {
                    ::protobuf::rt::read_unknown_or_skip_group(field_number, wire_type, is, self.mut_unknown_fields())?;
                },
