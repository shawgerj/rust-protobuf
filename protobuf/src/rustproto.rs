...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \n\x02\x03\0\x12\x03\x02\0*\nh\n\x01\x02\x12\x03\x07\0\x122^\x20see\x20h\
    ttps://github.com/gogo/protobuf/blob/master/gogoproto/gogo.proto\n\x20fo\
    r\x20the\x20original\x20idea\n\n\t\n\x01\x07\x12\x04\t\0\x14\x01\n7\n\
    \x02\x07\0\x12\x03\x0b\x04+\x1a,\x20When\x20true,\x20oneof\x20field\x20i\
    s\x20generated\x20public\n\n\n\n\x03\x07\0\x02\x12\x03\t\x07\"\n\n\n\x03\
